...
class ExecutionParametersDialog(QtGui.QDialog):
    ...
    def __init__(self, data):
        ...
        self.densitydt_type_input.setCurrentIndex(int(self.data['densitydt_type']))
        ...
        self.densitydt_input.setHelpText(utils.__(constants.HELP_DENSITYDT))
        self.densitydt_input.setMaxLength(10)

        self.densitydt_input.focus.connect(self.on_help_focus)

        self.densitydt_input.setText(str(self.data['densitydt_value']))
    ...
    def on_ok(self):
        ...
        self.data['densitydt_type'] = self.densitydt_type_input.currentIndex()
        self.data['densitydt_value'] = float(self.densitydt_input.text())
...
class InitialsDialog(QtGui.QDialog):
    ...
    def __init__(self, data):
        ...
        self.initials_vector_label = QtGui.QLabel(__("Direction: "))
        self.initials_vector_label.setToolTip(__("Sets the mk group direction vector."))
        ...
        if str(self.target_mk) in self.data['initials_mks'].keys():
            initials_property = self.data['initials_mks'][str(self.target_mk)]
            self.has_initials_selector.setCurrentIndex(0)
            self.on_initials_change(0)
            self.initials_vector_input_x.setText(str(initials_property.direction[0]))
            self.initials_vector_input_y.setText(str(initials_property.direction[1]))
            self.initials_vector_input_z.setText(str(initials_property.direction[2]))
            self.initials_type_selector.setCurrentIndex(initials_property.initials_type)
            self.initials_velocities_v1_input.setText(str(initials_property.v1))
            self.initials_velocities_v2_input.setText(str(initials_property.v2))
            self.initials_velocities_v3_input.setText(str(initials_property.v3))
            self.initials_velocities_z1_input.setText(str(initials_property.z1))
            self.initials_velocities_z2_input.setText(str(initials_property.z2))
            self.initials_velocities_z3_input.setText(str(initials_property.z3))
